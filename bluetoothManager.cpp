...
public:
	...
	{
		std::cout << "Bluetooth Manager starting" << std::endl;
	...
	~Discovery()
	{
		...
		std::cout << "Bluetooth Manager finished" << std::endl;
		return;
#if 0
		{
			//MARK;
		...
		std::cout << "Bluetooth finished" << std::endl;
#endif
	}
	...
	{
		if (m_discovery_complete.wait(30000) != 0)
			return false;
		else
			return true;
	}
